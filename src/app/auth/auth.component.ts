...
export class AuthComponent implements OnDestroy{
    ...
    constructor(private authService: AuthService, private router: Router, private compFactoryRes: ComponentFactoryResolver) {}
    onSwitchMode() {
    ...
    private showErrorAlert(message: string) {
        const alertCmpFactory = this.compFactoryRes.resolveComponentFactory(AlertComponent);
